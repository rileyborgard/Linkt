...
public class Constants {
    ...
    public static final int LEVELS_PER_ROW = 10, LEVELS_PER_COLUMN = 6;
    public static final int LEVELS = 26;
    ...
    public static Color BLOCK_COLOR = new Color(0.5f, 0, 0, 1f);
    ...
    public static Color ICE_CUBE_COLOR = new Color(0f, 0f, 1f, 0.75f);
    ...
    public static Color BLOCK_COLOR_OUTLINE = new Color(0.25f, 0, 0, 1f);
    ...
    public static Color BACKGROUND_COLOR = new Color(0f, 0f, 0f, 1f);

    public static void config() {
        WIDTH = Gdx.graphics.getWidth();
        HEIGHT = Gdx.graphics.getHeight();
        ARROW_BUTTON_SIZE = HEIGHT / 6;
//        TILE_SIZE = HEIGHT / 12;
        TILE_SIZE = 32;
        OUTLINE_SIZE = TILE_SIZE / 10;
        LEVEL_BUTTON_MARGIN = HEIGHT / 30;
